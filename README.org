...
* A web interface for subscribing to mailing lists
...
contacts/mailing lists but do not want your users to share data 
with an third-party sign-up form, =Subscribe= can help.

If you have several mailing lists (possibly handled by several
different providers from mailgun/mailjet/sendinblue) and want to 
list subscription option on a single page,  =Subscribe= can help.

[[file:subscribe.png]]

* Features

- Choose what mailing list you want to expose to your users
- UI and transactional emails in english and french
- Let the admin of a list receive an email every =x= subscription
- Customize the HTML header and footer
